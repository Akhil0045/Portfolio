...
//                                 <div className={`px-4 py-3 rounded-2xl text-sm sm:text-base leading-relaxed ${
//                                     msg.role === 'user'
...
//                             className="w-full h-12 sm:h-14 pl-4 sm:pl-5 pr-[3.25rem] sm:pr-[3.5rem] rounded-xl bg-gray-800 border border-gray-600 text-white placeholder-gray-500 text-base focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-all"
//                         />
//                         <button
//                             onClick={handleSend}
//                             disabled={isLoading || !input.trim()}
//                             className="absolute right-2.5 top-1/2 -translate-y-1/2 p-2.5 rounded-lg text-gray-400 hover:text-white hover:bg-white/10 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent transition-all flex items-center justify-center"
//                         >
...
export function Chat() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hi! I'm Akhil's AI assistant. Ask me about his projects, skills, or how to get in touch.",
    },
  ]);
  ...
  const handleSend = () => {
    ...
    setMessages((prev) => [
      ...
      {
        role: "assistant",
        content: "**Demo reply:** Backend connection works here.",
      },
    ]);
  };
      ...
      <header className="border-b border-gray-800 bg-black">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Bot size={20} />
            <div>
              <h1 className="text-sm font-semibold">Portfolio Assistant</h1>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative w-full">
            <input
              ...
              className="w-full h-14 pl-5 pr-14 rounded-xl bg-gray-900 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-600 text-white"
            />

            {/* SEND BUTTON INSIDE INPUT */}
            <button
              onClick={handleSend}
              className="absolute right-3 top-1/2 -translate-y-1/2 bg-blue-600 hover:bg-blue-500 p-2 rounded-lg transition"
            >
